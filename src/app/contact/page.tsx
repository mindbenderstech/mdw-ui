        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-10">
          <div className="space-y-6">
            ...
            <p className="text-lg text-gray-700">
              If you have any questions or would like to know more about **Headliness** and the news we provide, feel free to contact us!
            </p>
            ...
            <div className="space-y-4">
              <div className="flex items-center text-gray-700">
                ...
                <p>Email: <a onClick={(e) => e.preventDefault()} href="mailto:support@headliness.com" className="text-teal-700 hover:underline">support@headliness.com</a></p>
              </div>
              ...
              <div className="flex items-center space-x-6  p-1 rounded-lg bg-teal-100 shadow-md">
                ...
                <div className="flex space-x-6">
                  {/* Twitter Icon */}
                  <a onClick={(e) => e.preventDefault()}  href="https://twitter.com/headliness" className="text-teal-700 hover:text-white hover:bg-teal-600 p-2 rounded-full transition-all duration-300 ml-10">
                    <svg  className="w-20 h-10 text-blue-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                      <path fill-rule="evenodd" d="M22 5.892a8.178 8.178 0 0 1-2.355.635 4.074 4.074 0 0 0 1.8-2.235 8.343 8.343 0 0 1-2.605.981A4.13 4.13 0 0 0 15.85 4a4.068 4.068 0 0 0-4.1 4.038c0 .31.035.618.105.919A11.705 11.705 0 0 1 3.4 4.734a4.006 4.006 0 0 0 1.268 5.392 4.165 4.165 0 0 1-1.859-.5v.05A4.057 4.057 0 0 0 6.1 13.635a4.192 4.192 0 0 1-1.856.07 4.108 4.108 0 0 0 3.831 2.807A8.36 8.36 0 0 1 2 18.184 11.732 11.732 0 0 0 8.291 20 11.502 11.502 0 0 0 19.964 8.5c0-.177 0-.349-.012-.523A8.143 8.143 0 0 0 22 5.892Z" clip-rule="evenodd" />
                    </svg>
                    <h1 className="pl-3">Twitter</h1>
                  </a>

                  {/* Facebook Icon */}
                  <a onClick={(e) => e.preventDefault()}  href="https://facebook.com/headliness" className="text-blue-700 hover:text-white hover:bg-teal-600 p-2 rounded-full transition-all duration-300 ml-10">
                    <svg className="w-20 h-10 text-blue-700" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
