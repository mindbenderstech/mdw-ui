    ...
    <div className="bg-gray-50 py-16">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white shadow-md rounded-lg p-8 space-y-6 text-gray-700 leading-relaxed text-lg">
          <p>
            <strong>TheHeadlineWorld</strong> is committed to protecting your personal information and respecting your privacy.
          ...
          <p>
            TheHeadlineWorld uses cookies to remember your language preference and browsing activity. 
          ...
          <p>
            ...
            at <a href="mailto:support@TheHeadlineWorld.com" onClick={(e) => e.preventDefault()} className="text-teal-600 underline disabled">support@TheHeadlineWorld.com</a> 
